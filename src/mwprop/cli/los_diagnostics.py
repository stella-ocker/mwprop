...
def plot_ne_arms(s25,ne25,s,ne_lism_vec,nea_vec,ne1_vec,ne2_vec,DM,d,ldeg,bdeg,Darms,armarray,rsun,xvec,yvec,Armvec,ndir):
    ...
    suptitle(r'$\rm Output \ from \ los\_diagnostics$', fontsize=12)
...
def main():
    try:
        ...
        print('    Use  los_diagnostics  l       b     DM_D ndir v  with DM_D = DM or distance for ndir > or < 0, v=2025 (NE2025) or v=2001 (NE2001)')
        print('    e.g. los_diagnostics 57.51 -0.29   71.02   1 2025   for B1937+21 parameters evaluated by NE2025')
        sys.exit()
