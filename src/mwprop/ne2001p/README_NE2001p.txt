...
With GitHub (this is a private development repo): [github.com/stella-ocker/mwprop_dev](https://github.com/stella-ocker/mwprop_dev)
...
The ne2001() function evaluates NE2001p and can be imported from the mwprop.ne2001p.NE2001_dev module. The function output consists of four dictionaries: 
