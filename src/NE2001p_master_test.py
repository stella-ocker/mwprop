...
'''
A master script that may be run in the /src/ directory in order to test modifications to individual modules under /src/mwprop/.
Usage: python NE2001p_master_test.py ldeg bdeg dmd ndir [--options]
